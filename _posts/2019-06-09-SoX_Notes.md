...
Notice that the input and output are indicated as - in the pipe
```
sox input.m4a -G -t wav -r 16000 - remix 1,2  | 
sox -t wav - -t wav - speed 0.9 sox --vol 0.316 -t wav - -t wav - |
sox -t wav - -t wav output.wav trim 125.34 10.82
```
